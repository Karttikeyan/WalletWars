// ============================================================
//  WalletWars · getWalletData(address)
//  Lógica de lectura on-chain + scoring, extraída de server.js
//  para que GET /api/wallet/:address y POST /api/combatant
//  compartan la misma fuente de verdad SIN pasar por HTTP interno
//  (localhost no existe en serverless — cada llamada es un proceso aislado).
// ============================================================
...
// ── Función principal, reutilizada por GET /api/wallet/:address y POST /api/combatant ──
